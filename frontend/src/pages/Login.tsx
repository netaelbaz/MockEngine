  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-sm border border-zinc-100 px-10 py-12">
        ...
        <p className="text-zinc-500 text-sm mb-8">Access your SDK management portal.</p>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3.5 rounded-full bg-zinc-100 border border-transparent focus:border-indigo-400 focus:bg-white outline-none text-sm transition"
              />
            </div>
          </div>
